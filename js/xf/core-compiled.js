    ...
    XF.activate ? console.error("XF core has been double loaded") : (XF.browser || (XF.browser = {
        ...
        function() {
                ...
                initialize: function() {
                    XF.PWA.isSupported() && (XF.config.skipServiceWorkerRegistration ? e = new Promise(function(a, b) {
                        ...
                        if ("object" !== typeof b || null === b) console.error("Invalid message:", b);
                            ...
                            var c = l[a];
                            "undefined" ===
                            typeof c ? console.error("No handler available for message type:", a) : c(b)
                        }
            ...
            return {
                isSubscribed: null,
                initialize: function() {
                    XF.Push.isSupported() && (XF.config.skipPushNotificationSubscription ||
                        a())
                },
                registerWorker: a,
                ...
                handleSubscribeAction: function(a, b, c) {
                    XF.Push.isSubscribed || Notification.requestPermission().then(function(d) {
                        if ("granted" !==
                            d) console.error("Permission was not granted");
                        else {
                ...
                isSupported: function() {
                    return XF.PWA.isSupported() &&
                        XF.config.enablePush && XF.config.pushAppServerKey && "PushManager" in h && "Notification" in h
                },
                base64ToUint8: c,
            ...
            function a(a) {
                d(a).find(".js-expandWatch:not(.is-expanded)").each(function() {
                    ...
                    if (b) {
                        ...
                        l();
                        if (!a.data("expand-check-triggered") &&
                            (a.data("expand-check-triggered", !0), a.find("img").one("load", l), h.MutationObserver)) {
                            var k, n = !0,
                                x = function() {
                                    n = !1;
                                    l();
            ...
            return {
                ...
                handleResponse: function(a) {
                    ...
                    b.length && (a.success ? XF.setupHtmlInsert(a.html,
                        function(a, c, d) {
                            b.replaceWith(a)
                    ...
                    _onEvent: function(a) {
                        ...
                        if (!b.isDefaultPrevented()) {
                            if ("function" == typeof this[this.eventType]) b = this[this.eventType](a);
                                ...
                                typeof this.onEvent) b = this.onEvent(a);
            ...
            return {
                watch: function(a) {
                    ...
                    b.hasOwnProperty(a) || (b[a] = !0, d(k).on(a, "[data-xf-" + a + "]", function(b) {
                        ...
                        e(a, b) && d(b).data("xf-pointer-type",
                            a.pointerType)
                    }))
                },
                initElement: c,
            ...
            return {
                ...
                getElementHandler: function(a, b) {
                    return XF.Event.getElementHandler(a,
                        b, "click")
                },
                ...
                if (b) {
                    ...
                    for (e in b)
                        if (b.hasOwnProperty(e)) {
                            var g = b[e];
                            var l = d("<li />").css("cursor", "pointer").attr("unselectable", "on").attr("role",
                                "option").mouseenter(XF.proxy(this, "resultMouseEnter"));
                            ...
                            } else if (n = g.text, m.text = XF.htmlspecialchars(g.text), "undefined" !== typeof g.desc && (m.desc = XF.htmlspecialchars(g.desc)), "undefined" !== typeof g.icon ? m.icon = d('<img class="autoCompleteList-icon" />').attr("src", XF.htmlspecialchars(g.icon)) :
                                "undefined" !== typeof g.iconHtml && (m.icon = d('<span class="autoCompleteList-icon" />').html(g.iconHtml)), m.icon && (m.icon = m.icon[0].outerHTML), g.extraParams) {
                                var x = g.extraParams,
                                    r;
                                for (r in x)
                            ...
                            l.html(Mustache.render(this.options.displayTemplate,
                                m)).appendTo(this.$results)
                        }
                        ...
                        var t = this.$results,
                            A = function(a) {
                                ...
                                if (!a) {
                                    ...
                                    XF.isRtl() &&
                                        (a.right = d("html").width() - b.left - c.outerWidth(), a.left = "auto")
                                }
                                return a
                            };
                        this.stopScrollWatching();
            ...
            insertSelectedResult: function(a) {
                ...
                0 <= this.selectedResult && (b = this.$results.children().get(this.selectedResult)) &&
                    (c = this.getResultText(b), this.options.beforeInsert && (c = this.options.beforeInsert(c, b)), this.insertResult(c, b, a), c = !0);
                this.hideResults();
                return c
            },
            ...
            init: function() {
                ...
                this.ed ? (this.ed.events.on("keydown", XF.proxy(this, "keydown"), !0), this.ed.events.on("keyup", XF.proxy(this, "keyup"), !0), this.ed.events.on("click blur", XF.proxy(this, "blur")), d(this.ed.$wp).onPassive("scroll", XF.proxy(this, "blur"))) : (this.$input.on("keydown", XF.proxy(this,
                    "keydown")), this.$input.on("keyup", XF.proxy(this, "keyup")), this.$input.on("click blur", XF.proxy(this, "blur")), d(k).onPassive("scroll", XF.proxy(this, "blur")))
            },
            keydown: function(a) {
            ...
            if (a && XF.isIOS()) {
                ...
                if (e && this.menuRef.left == e[0] && this.menuRef.width == e[1]) {
                    ...
                    "fixed" == k && k != b.css("position") ? (g = {
                        ...
                        "transition-property": "none",
                        "transition-duration": "0s"
                    }, g = this.getVerticalAbsolutePosition(e,
                        g));
    ...
    XF.Tabs = XF.Element.newHandler({
        ...
        activateTab: function(a) {
            ...
            b.length && c.length ? (this.$tabs.filter("." + d).removeClass(d).attr("aria-selected", "false").trigger("tab:hidden"), this.$panes.filter("." + d).removeClass(d).attr("aria-expanded", "false").trigger("tab:hidden"), b.addClass(d).attr("aria-selected",
                "true").trigger("tab:shown"), c.addClass(d).attr("aria-expanded", "true").trigger("tab:shown"), XF.layoutChange(), c.data("href") && !c.data("tab-loading") && (c.data("tab-loading", !0), XF.ajax("get", c.data("href"), {}, function(a) {
                c.data("href", !1);
                if (a.html) {
